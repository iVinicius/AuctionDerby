...
public class AuctionDetailsController {
	 ...
	 */
	public AuctionDetailsController(String auctionidStr, Long userId) {
		initialize(auctionidStr);
	 ...
	 */
	private void initialize(String auctionidStr) {
		frame = new JFrame();
		...
		txtAuctionId = new JTextField(auctionidStr);
		...
		JButton btnAuctionCreate = new JButton("Criar leilao");
	...
	private void actionPerformedCreateAuction(){
		try{
			...
			Facade.getInstance().createAuction(byDemand, hiddenBids, txtDataInicio.getText(), txtDataFim.getText(), userId.toString(), txtLotValue.getText());
	...
	// check if there's a user logged in, otherwise show a message telling to login
